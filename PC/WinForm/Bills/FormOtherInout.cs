...
{
    public partial class FormOtherInout: Office2007Form
    {
        ...
        public FormOtherInout(string subBillType)
        {
            InitializeComponent();
...
//                        客户编号 = c.CustId,
        ...
        {
            int count;
            Expression<Func<VIEW_OTHER_INOUT, dynamic>> select = c => c;
            Expression<Func<VIEW_OTHER_INOUT, bool>> where = c => c.单据号 == billNum;
            Expression<Func<VIEW_OTHER_INOUT, long>> order = c => c.UID;
