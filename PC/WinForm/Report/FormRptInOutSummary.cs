...
{
    public partial class FormRptInOutSummary : Office2007Form
    {
        private DateTime _beginTime = DateTime.Now.AddDays(-1);
        private DateTime _endTime = DateTime.Now.AddDays(1);
        private List<VIEW_IO_SUMMARY> _billList;
        private VIEW_IO_SUMMARY _selectedBill;
        public FormRptInOutSummary()
        {
            InitializeComponent();
            _billList = new List<VIEW_IO_SUMMARY>();
        ...
        {
            _billList = new List<VIEW_IO_SUMMARY>();
            _selectedBill = new VIEW_IO_SUMMARY();
            GetBillList();
        }
        ...
        private void GetBillList()
        {
            ...
            {
                _billList = ReportViewController.GetIoSummarysDetailList(db,_beginTime, _endTime);
        ...
        private void Search()
        {
            ...
            _billList = new List<VIEW_IO_SUMMARY>(list);
        ...
        {
            DataTable dt = DataGridViewHelper.DgvToTable(dgvBill, "VIEW_IO_SUMMARY");
