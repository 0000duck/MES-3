...
{
    public partial class FormRptInOutSummaryByArea : Office2007Form
    {
        private DateTime _beginTime = DateTime.Now.AddDays(-1);
        private DateTime _endTime = DateTime.Now.AddDays(1);
        private List<VIEW_IO_SUMMARY_ByArea> _billList;
        private VIEW_IO_SUMMARY_ByArea _selectedBill;
        public FormRptInOutSummaryByArea()
        {
            InitializeComponent();
            _billList = new List<VIEW_IO_SUMMARY_ByArea>();
        ...
        {
            _billList = new List<VIEW_IO_SUMMARY_ByArea>();
            _selectedBill = new VIEW_IO_SUMMARY_ByArea();
            GetBillList();
        }
        ...
        private void GetBillList()
        {
            ...
            {
                _billList = ReportViewController.GetIoSummarysByAreaDetailList(db,_beginTime, _endTime);
        ...
        private void Search()
        {
            ...
            _billList = new List<VIEW_IO_SUMMARY_ByArea>(list);
        ...
        {
            DataTable dt = DataGridViewHelper.DgvToTable(dgvBill, "VIEW_IO_SUMMARY_ByArea");
