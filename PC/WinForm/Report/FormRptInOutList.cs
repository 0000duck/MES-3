...
{
    public partial class FormRptInOutList : Office2007Form
    {
        private DateTime _beginTime = DateTime.Now.AddDays(-1);
        private DateTime _endTime = DateTime.Now.AddDays(1);
        private List<VIEW_TRANSACTION> _billList;
        private VIEW_TRANSACTION _selectedBill;
        public FormRptInOutList()
        {
            InitializeComponent();
            _billList = new List<VIEW_TRANSACTION>();
        ...
        {
            _billList = new List<VIEW_TRANSACTION>();
            _selectedBill = new VIEW_TRANSACTION();
            GetBillList();
        }
        ...
        private void GetBillList()
        {
            ...
            {
                _billList = ReportViewController.GetTransaticonList(db,_beginTime, _endTime);
        ...
        private void Search()
        {
            ...
            _billList = new List<VIEW_TRANSACTION>(list);
        ...
        {
            DataTable dt = DataGridViewHelper.DgvToTable(dgvBill, "VIEW_TRANSACTION");
