...
namespace ChangKeTec.Wms.Utils
{
    ...
    public class FtpHelper
    {
        ...
        /// <param name="ftpRootPath">指定FTP连接成功后的当前目录, 如果不指定即默认为根目录</param>
        /// <param name="ftpUserId">用户名</param>
        /// <param name="ftpPassword">密码</param>
        public FtpHelper(string ftpServer,string ftpPort, string ftpRootPath, string ftpUserId, string ftpPassword)
        {
            _ftpServer = ftpServer;
            _ftpPort = ftpPort;
            _ftpRootPath = ftpRootPath;
            _ftpUserId = ftpUserId;
            _ftpPassword = ftpPassword;
            _ftpUri = "ftp://" + _ftpServer +":"+_ftpPort+ "/" + _ftpRootPath + "/";
        }

        public void UploadList(List<string> filenameList)
        {
        ...
        public void Upload(string filename)
        {
            ...
            Console.WriteLine("Upload " + Path.GetFileName(filename));
        ...
        public void Delete(string fileName)
        {
            ...
            {
               Console.WriteLine( "Delete Error --> " + ex.Message + "  文件名:" + fileName);
            }
        }
        ...
        public void RemoveDirectory(string folderName)
        {
            ...
            {
               Console.WriteLine( "Delete Error --> " + ex.Message + "  文件名:" + folderName);
            }
        }
        ...
        public string[] GetFilesDetailList()
        {
            ...
            {
                downloadFiles = null;
               Console.WriteLine( "GetFilesDetailList Error --> " + ex.Message);
        ...
        public string[] GetFileList(string mask)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                   Console.WriteLine( "GetFileList Error --> " + ex.Message.ToString());
                }
                return downloadFiles;
            }
        }
        ...
        public void GotoDirectory(string pathName, bool isRoot)
        {
            if (isRoot)
            {
                _ftpUri = "ftp://" + _ftpServer + "/" + pathName + "/";
            }
            else
            {
                _ftpUri = "ftp://" + _ftpServer + "/" + _ftpRootPath + "/" + pathName + "/";
            }
        }
        ...
        public static void DeleteOrderDirectory(string ftpServerIP,string ftpPort, string folderToDelete, string ftpUserID, string ftpPassword)
        {
            try
            {
                ...
                {
                    FtpHelper fw = new FtpHelper(ftpServerIP,ftpPort, folderToDelete, ftpUserID, ftpPassword);
                    //进入订单目录
